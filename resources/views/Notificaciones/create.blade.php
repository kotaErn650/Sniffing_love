                ...
                <form method="POST" action="{{ route('notificaciones.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="leida" id="leida" class="form-control" required>
                            <option value="1" {{ old('leida') === '1' ? 'selected' : '' }}>Sí</option>
                            <option value="0" {{ old('leida') === '0' ? 'selected' : '' }}>No</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" name="fecha_leida" id="fecha_leida" class="form-control" value="{{ old('fecha_leida') }}">
                    </div>

                    <div class="mb-3">
                        <label for="url_accion" class="form-label">URL de Acción</label>
                        <input type="url" name="url_accion" id="url_accion" class="form-control" value="{{ old('url_accion') }}">
                    </div>

                    <button type="submit" class="btn btn-warning">Guardar Notificación</button>
